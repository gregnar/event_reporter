...
class CommandParserTest < Minitest::Test
  ...
  def test_parser_cleans_long_third_commands
    ...
    assert_equal ["find", "address", "147-77 225th street"], @parser.account_for_long_criteria(long_command, true, "address")
  end
  ...
  def test_parser_successfully_cleans_for_both_conditions
    true_test = "find address 890 Dexter Apt 101"
    assert_equal ["find", "address", "890 Dexter Apt 101"], @parser.modify_commands(true_test)
  end
